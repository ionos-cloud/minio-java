 ...
 * used to perform S3 operations. Credential consumer like {@link com.ionoscloud.s3.ApiClient} calls
 * {@link #fetch()} to get credentials. It is provider's responsibility to retrieve credentials upon
 * expiry when {@link #fetch()} is called.
 */
